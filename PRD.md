...
|------|-------|----------|--------|
| **Freemium** | Free | 3 maps, 50 pins/map, 3 AI suggestions/day, 2 collaborators/map, 3 curated maps on /discover | AI suggestion + map/pin/seat limits enforced |
| **Basic** | £4.99/month | 10 maps, 200 pins/map, 15 AI suggestions/day, 8 collaborators/map, screenshot-based AI import, archive & restore maps, custom pin colors & icons, full /discover access | AI suggestion + map/pin/seat limits + screenshot import + map archiving + pin customization gates enforced |
| **Premium** | £9.99/month | Unlimited maps/pins/seats, 200 AI suggestions/day, custom branding, screenshot-based AI import, archive & restore maps, custom pin colors & icons, full /discover access | AI suggestion + map/pin/seat limits + custom branding + screenshot import + map archiving + pin customization gates enforced |
